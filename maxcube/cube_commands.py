        ...
        self.fields = [ffixed('msg_type', b'L:'),
                       fbase64(
                               fmultiple('devices'                          , ALL,
                                      ...
                                      fflags(
                                            ['valid'  , 0b00010000, {0:'invalid'               , 1:'information provided is valid'}],
                                            ['error'  , 0b00001000, {0:'no'                    , 1:'error occurred'}],
                                            ['answer' , 0b00000100, {0:'an answer to a command', 1:'not an answer to a command'}],
                                            ['status' , 0b00000010, {0:'not initialized'       , 1:'initialized'}]),
                                      fflags(
                                            ['battery'    , 0b10000000, {0:'ok'      , 1:'low'}],
                                            ['link'       , 0b01000000, {0:'ok'      , 1:'error'}],
                                            ['panel'      , 0b00100000, {0:'unlocked', 1:'locked'}],
                                            ['gateway'    , 0b00010000, {0:'unknown' , 1:'known'}],
                                            ['dst setting', 0b00001000, {0:'inactive', 1:'active'}],
